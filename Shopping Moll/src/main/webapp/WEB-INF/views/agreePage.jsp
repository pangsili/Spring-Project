...
<body>
	<div align="center">
		<form action="" id="frm">
			<table>
				<tr>
					<td colspan="2"><h1 align="center">NAVER</h1></td>
					<td></td>
				</tr>
				<tr>
					<td colspan="2"><input type="checkbox" id="allCheck" onclick="doAllCheck()">
						<label for="allCheck">네이버 이용약관, 개인정보 수집 및 이용, 위치기반서비스 이용약<br/>
											      관(선택), 프로모션 정보 수신(선택)에 모두 동의합니다.<br/></label></td>
					<td></td>
				</tr>
				<tr>
					<td colspan="2"><input type="checkbox" id="necessaryCheck1">
						<label for="necessaryCheck1">네이버 이용약관 동의(필수)</label><br/>
									<textarea rows="5" cols="65" readonly="readonly">
										여러분을 환영합니다.
	...
	네이버 서비스와 관련하여 궁금하신 사항이 있으시면 고객센터(대표번호: 1588 – 3820/ 평일 09:00~18:00)로 문의 주시기 바랍니다.
				...
				<tr>
					<td colspan="2"><input type="checkbox" id="necessaryCheck2"> 개인정보 수집 및 이용 동의(필수)<br/>
									<textarea rows="5" cols="65" readonly="readonly">
	...
	이용자는 개인정보의 수집 및 이용 동의를 거부할 권리가 있습니다. 회원가입 시 수집하는 최소한의 개인정보, 즉, 필수 항목에 대한 수집 및 이용 동의를 거부하실 경우, 회원가입이 어려울 수 있습니다.
				...
				<tr>
					<td colspan="2"><input type="checkbox" id="choiceCheck1"> 
						<label for="choiceCheck1">위치기반서비스 이용약관 동의(선택)</label><br/>
									<textarea rows="5" cols="65" readonly="readonly">
	...
	2022년 4월 27일부터 시행되던 종전의 약관은 본 약관으로 대체하며, 본 약관은 2022년 5월 18일부터 적용됩니다.
				...
				<tr>
					<td colspan="2"><input type="checkbox" id="choiceCheck2"> 
						<label for="choiceCheck2">프로모션 정보 수신 동의(선택)</label><br/>
									<p style="font-size: '8px'">
										네이버 서비스 및 제휴 이벤트・혜택 등의 정보를 휴대전화(네이버앱 알림 또는 문<br/>
										자), 이메일로 받을 수 있습니다. 일부 서비스(별개의 회원 체계 운영, 네이버 가입 후<br/>
				...
				<tr>
					<td colspan="2" align="center">
						<a href="./selectHowPage" id="cancel">취소</a>
						<a href="javascript:boxCheck()" id="agree">확인</a><br/><br/>
						<h5>회사, 동아리 등 단체에서 사용할 ID가 필요하세요?<br/>
							<a href="">단체 회원 가입</a></h5>
					</td>
					<td></td>
				</tr>
				<tr>
					<td colspan="2" align="center"><p style="font-size: small;">이용약관 ㅣ 개인정보처리방침 ㅣ 책임의 한계와 법적고지 ㅣ 회원정보 고객센터<br/>
					c NAVER Corp.</p></td>
				</tr>
			</table>
		</form>
...
<script type="text/javascript">
	function doAllCheck(){
		...
		if(frm.allCheck.checked == true){
			...
			frm.necessaryCheck1.checked = true;
			frm.necessaryCheck2.checked = true;
			frm.choiceCheck1.checked = true;
			frm.choiceCheck2.checked = true;
		}else{
			
			frm.necessaryCheck1.checked = false;
			frm.necessaryCheck2.checked = false;
			frm.choiceCheck1.checked = false;
			frm.choiceCheck2.checked = false;
		}
	}
	function boxCheck(){
		
		if(frm.necessaryCheck1.checked == false){
			
			alert("필수항목을 체크해주세요.");
			return;
		}
		if(frm.necessaryCheck2.checked == false){
			
			alert("필수항목을 체크해주세요.");
			return;
		}
		
		location.href = "./makingPage";
	}	
</script>
</body>
</html>